...
label_dir = os.path.abspath(sys.argv[2])
train_set = torchvision.datasets.MNIST(img_dir, train=True, download=True)
print("MNIST: label_dir", label_dir)
print("MNIST: img_dir", img_dir)

#10 images per class
per_class = 10
label_dir = os.path.join(label_dir, str(10 * per_class)+"_balanced_labels")
